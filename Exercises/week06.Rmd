...
and run the function.
    i. When `browser()` stops the function, print out the value of v. 
    ii. Step through the function with `n` a few times and then type `c` to 
    continue to the next call to `browser()`. Print v again. 
    iii. Repeat a few times until the function stops. What was
