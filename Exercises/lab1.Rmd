...
1. If you have not already done so, go to github.com, click "Sign Up" and
create your GitHub account.
2. Send your GitHub account name to Pulindu (pulindu_ratnasekera@sfu.ca)
and Brad (mcneney@sfu.ca) so that they can
add you as a collaborator on the Stat 360 projects
repository (https://github.com/SFUStatgen/SFUStat360Projects). Include the words "Stat 360 GitHub user" in the subject of your message.
